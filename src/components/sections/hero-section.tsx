  ...
  return (
    <section className="space-y-4 py-24 md:py-32">
      <div className="grid gap-4 md:grid-cols-5">
        <Card className="col-span-5 bg-muted/50 p-12 pt-16 pb-24">
        ...
        <Card className="flex items-center justify-center bg-muted/50 p-12 py-6 col-span-3">
          <CardContent className="flex gap-4 p-0 items-end">
            <TooltipProvider>
            {[
              { name: "JavaScript", image: "/javascript.png", fallback: "JS" },
              { name: "TypeScript", image: "/typescript.png", fallback: "TS" },
              ...
              { name: "Tailwind CSS", image: "/tailwindcss.png", fallback: "TC" },
